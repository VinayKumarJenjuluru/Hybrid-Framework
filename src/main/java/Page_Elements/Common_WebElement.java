...
public class Common_WebElement {
    ...
    @FindBy(xpath="//div[@class='slds-m-top_small slds-col']//following-sibling::button")
    public WebElement element_GridElecPrefill;
    public WebElement getelement_GridElecPrefill(){
        return element_GridElecPrefill;
    }
    ...
    public Common_WebElement(WebDriver driver) {
